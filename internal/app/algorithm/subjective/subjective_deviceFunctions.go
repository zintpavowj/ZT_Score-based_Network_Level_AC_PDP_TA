...
func (a *SubjectiveAlgorithm) getDevice() error {
	var d pipDeviceT
...
func (a *SubjectiveAlgorithm) getDeviceTrustHistory() error {
	var th []float32
...
func (a *SubjectiveAlgorithm) getDeviceIPHistory() error {
	var history []string
...
func (a *SubjectiveAlgorithm) getDeviceServiceUsageHistory() error {
	var s []string
...
func (a *SubjectiveAlgorithm) getDeviceUserUsageHistory() error {
	var s []string
...
func (a *SubjectiveAlgorithm) getDeviceAuthPatternHistory() error {
	var h []string
