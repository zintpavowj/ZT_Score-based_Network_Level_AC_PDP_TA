...
func (a *SubjectiveAlgorithm) getUser() error {
	var u pipUserT
...
func (a *SubjectiveAlgorithm) getUserTrustHistory() error {
	var th []float32
...
func (a *SubjectiveAlgorithm) getUserServiceUsageHistory() error {
	var s []string
...
func (a *SubjectiveAlgorithm) getUserAccessRateHistory() error {
	var s []float32
...
func (a *SubjectiveAlgorithm) getUserInputBehaviorHistory() error {
	var s []float32
...
func (a *SubjectiveAlgorithm) getUserDeviceUsageHistory() error {
	var s []string
...
func (a *SubjectiveAlgorithm) getUserAuthPatternHistory() error {
	var h []string
